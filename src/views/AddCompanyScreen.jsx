...
const AddCompanyScreen = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (selectedCompany.trim() === "" || selectedCity.trim() === "Ciudades") {
            console.log("error")
            return
        }
        setCcompanies([
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="row">
                <div className="col-6">
                    <label htmlFor="city" className="form-label">Agregar Compañia</label>
                    <input type="text" className="form-control" placeholder="Ingresa una compañia" id="city" value={selectedCompany}
                        onChange={e => handleInput(e)} name="selectedCompany" />
                </div>
                <div className="col-6">
                    <label className="form-label">Seleccionar ciudad</label>
                    <br />
                    <select className="form-control" onChange={e => handleInput(e)} name="selectedCity">
